package com.technosoft.datos;

import com.technosoft.dominio.Estudiante;
...
import static com.technosoft.conexion.Conexion.getConexion;
...
public class EstudianteDAO {
    ...
    public List<Estudiante> listarEstudiantes(){
        ...
        String sql = "SELECT id_estudiante, nombre, apellido, telefono, email FROM estudiante ORDER BY id_estudiante";
        try{
    ...
    public boolean buscarEstudiantePorId(Estudiante estudiante){
        ...
        try {
            ...
            System.out.println("Ocurrió un error al buscar al estudiante: " + estudiante + " " + e.getMessage());
        }
        finally {
            try {
                con.close();
    ...
    public boolean agregarEstudiante(Estudiante estudiante){
        ...
        try {
            ...
            System.out.println("Ocurrió un error al intentar el estudiante: " + estudiante + " " + e.getMessage());
        }
        finally {
            try {
                con.close();
...
//                "Juarez", "55443322", "juancarlos@email.com");
